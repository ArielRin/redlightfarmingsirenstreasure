      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            ...
            <LinkExternal href="https://exchange.pancakeswap.finance/#/add/BNB/0x93E7ae1eF759Ee2dBEf0F87424b08d7Af7E4BcA5">
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with Sirens Treasure, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
