...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({ details, apr, multiplier, liquidity }) => {
  ...
  const bsc = `https://redlightscan.finance/address/${lpAddress}`
  const info = `https://redlc.sirenstreasure.tk/pair/${lpAddress}`
  ...
  return (
    <Container>
      <InfoContainer>
        <StakeContainer>
          <StyledLinkExternal href={`https://dawnswap.finance/#/add/${liquidityUrlPathParts}`}>
